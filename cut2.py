...
def niito2D(filepath):
    ...
    outputfile = '/data/jytang/bysy_paired/CT_train/'       #输出文件夹
    ...
    for path in paths:
        ...
        for current_slice in range(2, total_slices-2):
            # alternate slices
            if (slice_counter % 1) == 0:
                ...
                if (slice_counter % 1) == 0:
                    ...
                    image_name = image_name.replace('reg_ct','')
...
if __name__ == '__main__':
    niito2D('/data/jytang/bysy_all_nii/220412239/220412239_reg_ct.nii.gz')